% This script calculates threshold for "Classic Watershed" (plugin for
% Fiji) based on Otsu's method.
...
adjustmentParameter = 0.3; % The lager value makes the smaller positive area 
...
threshold = round(max(image(:)) - tempThreshold * adjustmentParameter) 
